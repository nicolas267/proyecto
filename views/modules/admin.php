                    ...
                    <div class="navbar-custom-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li>
                                                ...
                                                <a href="views/#">
                                                    <div class="pull-left">
                                                        <img alt="User Image" class="img-circle" src="views/dist/img/user2-160x160.jpg">
                                                        </img>
                                                    </div>
                                                    <h4>
                                                        Support Team
                                            ...
                                            <li>
                                                <a href="views/#">
                                                    <div class="pull-left">
                                                        <img alt="User Image" class="img-circle" src="views/dist/img/user3-128x128.jpg">
                                                        </img>
                                                    </div>
                                                    <h4>
                                            ...
                                            <li>
                                                <a href="views/#">
                                                    <div class="pull-left">
                                                        <img alt="User Image" class="img-circle" src="views/dist/img/user4-128x128.jpg">
                                                        </img>
                                                    </div>
                                                    <h4>
                                                        Developers
                      ...
                      page and may cause design problems
                            ...
                            <li class="dropdown user user-menu">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="views/#">
                                    <img alt="User Image" class="user-image" src="views/dist/img/user2-160x160.jpg">
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="box box-warning direct-chat direct-chat-warning">
                                        <div class="box-header with-border">
                                            ...
                                            <div class="box-tools pull-right">
                                                <span class="badge bg-yellow" data-toggle="tooltip" title="3 New Messages">
                                                    3
                                                </span>
                                                <button class="btn btn-box-tool" data-widget="collapse" type="button">
                                                    <i class="fa fa-minus">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="direct-chat-messages">
                                                ...
                                                <div class="direct-chat-msg">
                                                    ...
                                                    <!-- /.direct-chat-info -->
                                                    <img alt="message user image" class="direct-chat-img" src="views/dist/img/user1-128x128.jpg">
                                                        <!-- /.direct-chat-img -->
                                                ...
                                                <div class="direct-chat-msg right">
                                                    ...
                                                    <!-- /.direct-chat-info -->
                                                    <img alt="message user image" class="direct-chat-img" src="views/dist/img/user3-128x128.jpg">
                                                        <!-- /.direct-chat-img -->
                                                        <div class="direct-chat-text">
                                            ...
                                            <div class="direct-chat-contacts">
                                                <ul class="contacts-list">
                                                    <li>
                                                        <a href="views/#">
                                                            <img alt="User Image" class="contacts-list-img" src="views/dist/img/user1-128x128.jpg">
                                                    ...
                                                    <li>
                                                        <a href="views/#">
                                                            <img alt="User Image" class="contacts-list-img" src="views/dist/img/user7-128x128.jpg">
                                                                <div class="contacts-list-info">
                                                                    <span class="contacts-list-name">
                                                                        Sarah Doe
                                                                        <small class="contacts-list-date pull-right">
                                                    ...
                                                    <li>
                                                        <a href="views/#">
                                                            <img alt="User Image" class="contacts-list-img" src="views/dist/img/user3-128x128.jpg">
                                                                <div class="contacts-list-info">
                                                                    <span class="contacts-list-name">
                                                                        Nadia Jolie
                                                                        <small class="contacts-list-date pull-right">
                                                    ...
                                                    <li>
                                                        <a href="views/#">
                                                            <img alt="User Image" class="contacts-list-img" src="views/dist/img/user5-128x128.jpg">
                                                                <div class="contacts-list-info">
                                                                    <span class="contacts-list-name">
                                                                        Nora S. Vans
                                                                        <small class="contacts-list-date pull-right">
                                                    ...
                                                    <li>
                                                        <a href="views/#">
                                                            <img alt="User Image" class="contacts-list-img" src="views/dist/img/user6-128x128.jpg">
                                                                <div class="contacts-list-info">
                                                                    <span class="contacts-list-name">
                                                                        John K.
                                                                        <small class="contacts-list-date pull-right">
                                                    ...
                                                    <li>
                                                        <a href="views/#">
                                                            <img alt="User Image" class="contacts-list-img" src="views/dist/img/user8-128x128.jpg">
                                                                <div class="contacts-list-info">
                                                                    <span class="contacts-list-name">
                                                                        Kenneth M.
                                                                        <small class="contacts-list-date pull-right">
                                    ...
                                    <div class="box box-danger">
                                        ...
                                        <div class="box-body no-padding">
                                            <ul class="users-list clearfix">
                                                <li>
                                                    <img alt="User Image" src="views/dist/img/user1-128x128.jpg">
                                                        <a class="users-list-name" href="views/#">
                                                            Alexander Pierce
                                                        </a>
                                                ...
                                                <li>
                                                    <img alt="User Image" src="views/dist/img/user8-128x128.jpg">
                                                        <a class="users-list-name" href="views/#">
                                                            Norman
                                                        </a>
                                                        <span class="users-list-date">
                                                ...
                                                <li>
                                                    <img alt="User Image" src="views/dist/img/user7-128x128.jpg">
                                                        <a class="users-list-name" href="views/#">
                                                            Jane
                                                        </a>
                                                        <span class="users-list-date">
                                                ...
                                                <li>
                                                    <img alt="User Image" src="views/dist/img/user6-128x128.jpg">
                                                        <a class="users-list-name" href="views/#">
                                                            John
                                                        </a>
                                                        <span class="users-list-date">
                                                ...
                                                <li>
                                                    <img alt="User Image" src="views/dist/img/user2-160x160.jpg">
                                                        <a class="users-list-name" href="views/#">
                                                            Alexander
                                                        </a>
                                                        <span class="users-list-date">
                                                ...
                                                <li>
                                                    <img alt="User Image" src="views/dist/img/user5-128x128.jpg">
                                                        <a class="users-list-name" href="views/#">
                                                            Sarah
                                                        </a>
                                                        <span class="users-list-date">
                                                ...
                                                <li>
                                                    <img alt="User Image" src="views/dist/img/user4-128x128.jpg">
                                                        <a class="users-list-name" href="views/#">
                                                            Nora
                                                        </a>
                                                        <span class="users-list-date">
                                                ...
                                                <li>
                                                    <img alt="User Image" src="views/dist/img/user3-128x128.jpg">
                                                        <a class="users-list-name" href="views/#">
                                                            Nadia
                                                        </a>
                                                        <span class="users-list-date">
                                        ...
                                        <div class="box-footer text-center">
                                            <a class="uppercase" href="views/javascript:void(0)">
                                                View All Users
                                            </a>
                                        </div>
                                        <!-- /.box-footer -->
                            ...
                            <div class="box box-info">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table no-margin">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="views/pages/examples/invoice.html">
                                                            OR9842
                                                        </a>
                                                    </td>
                                                    <td>
                                ...
                                <div class="box-footer clearfix">
                                    <a class="btn btn-sm btn-info btn-flat pull-left" href="views/javascript:void(0)">
                                        Place New Order
                                    </a>
                                    <a class="btn btn-sm btn-default btn-flat pull-right" href="views/javascript:void(0)">
                                        View All Orders
                                    </a>
                                </div>
                                <!-- /.box-footer -->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="info-box bg-yellow">
                                <span class="info-box-icon">
                                    <i class="ion ion-ios-pricetag-outline">
                                    </i>
                                </span>
                                <div class="info-box-content">
                                    <span class="info-box-text">
                            ...
                            <div class="info-box bg-green">
                                <span class="info-box-icon">
                                    <i class="ion ion-ios-heart-outline">
                                    </i>
                                </span>
                                <div class="info-box-content">
                                    <span class="info-box-text">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <ul class="chart-legend clearfix">
                                                ...
                                                <li>
                                                    <i class="fa fa-circle-o text-gray">
                                                    </i>
                                                    Navigator
                                                </li>
                                            </ul>
                                    ...
                                    <ul class="products-list product-list-in-box">
                                        <li class="item">
                                            <div class="product-img">
                                                <img alt="Product Image" src="views/dist/img/default-50x50.gif">
                                                </img>
                                            </div>
                                            <div class="product-info">
                                                <a class="product-title" href="views/javascript:void(0)">
                                                    Samsung TV
