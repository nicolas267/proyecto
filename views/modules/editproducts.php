 <?php
      if ($_POST) {
        $ingreso = new ShowProduct();
        $ingreso -> edit();
      }
         if (!$_POST) {  
          $products = new ShowProduct();
        $product = $products -> Showproducta();       
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <div class="navbar-custom-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li>
                                                ...
                                                <a href="../views/#">
                                                    <div class="pull-left">
                                                        <img alt="Product Image" class="img-circle" src="../views/dist/img/Product2-160x160.jpg">
                                                        </img>
                                                    </div>
                                                    <h4>
                                                        Support Team
                                            ...
                                            <li>
                                                <a href="../views/#">
                                                    <div class="pull-left">
                                                        <img alt="Product Image" class="img-circle" src="../views/dist/img/Product3-128x128.jpg">
                                                        </img>
                                                    </div>
                                                    <h4>
                                            ...
                                            <li>
                                                <a href="../views/#">
                                                    <div class="pull-left">
                                                        <img alt="Product Image" class="img-circle" src="../views/dist/img/Product4-128x128.jpg">
                                                        </img>
                                                    </div>
                                                    <h4>
                                                        Developers
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li>
                                                <a href="../views/#">
                                                    <i class="fa fa-Products text-aqua">
                                                    </i>
                      ...
                      page and may cause design problems
                                            ...
                                            <li>
                                                <a href="../views/#">
                                                    <i class="fa fa-Product text-red">
                                                    </i>
                                                    You changed your Productname
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <!-- Product Account: style can be found in dropdown.less -->
                            <li class="dropdown Product Product-menu">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="../views/#">
                                    <img alt="Product Image" class="Product-image" src="../views/dist/img/Product2-160x160.jpg">
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <?php foreach ($product as $pro) {
                        ...
                        echo '
                  <label >Title</label>
                  <input type="text" class="form-control" name="title" placeholder="Title" value="'. $pro['title'].'">
                </div>
                <div class="form-group">
                  <label >Description</label>
                  <input type="text" class="form-control" name="description" placeholder="Description" value="'.$pro['description'].'">
                </div>
                <div class="form-group">
                <select class="form-control " style="width: 100%;" name="category" tabindex="-1" aria-hidden="true">
                  ...
                  <div class="form-group">
                  <label >Price</label>
                  <input type="text" class="form-control" name="price" placeholder="Price" value="'.$pro['price'].'">
                </div>';
             } ?>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="control-sidebar-home-tab">
            ...
            <ul class="control-sidebar-menu">
                ...
                <li>
                    <a href="../views/javascript:void(0)">
                        <i class="menu-icon fa fa-Product bg-yellow">
                        </i>
                        <div class="menu-info">
                            <h4 class="control-sidebar-subheading">
        ...
        <div class="tab-pane" id="control-sidebar-settings-tab">
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <p>
                        Allow the Product to show his name in blog posts
                    </p>
                </div>
                <!-- /.form-group -->
                <h3 class="control-sidebar-heading">
